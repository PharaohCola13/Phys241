...
print("The force of gravity acting on craft one is {} N".format(Fgrav))
print("The force of gravity acting on craft two is {} N".format(Fgrav1))
print("The force of gravity acting on craft three is {} N".format(Fgrav2))
print("The force of gravity acting on craft four is {} N".format(Fgrav3))
print("The force of gravity acting on craft five is {} N".format(Fgrav4))
